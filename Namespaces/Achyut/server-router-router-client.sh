...
sudo ip link add v-net-1 type bridge
sudo ip link set dev v-net-0 up
sudo ip link set dev v-net-1 up
sudo ip link add veth0 type veth peer name veth0-br
sudo ip link add veth1 type veth peer name veth1-br
sudo ip link add veth-br-0 type veth peer name veth-br-1

sudo ip link set veth0 netns server1
sudo ip link set veth0-br master v-net-0
sudo ip link set veth-br-0 master v-net-0
sudo ip link set veth-br-1 master v-net-1
sudo ip link set veth1 netns client1
sudo ip link set veth1-br master v-net-1
